...
?>
                        ...
                        <div class="col-row__page">
                            ...
                            <article class="column column--main pull-right" role="main">  
                                <div class="content--main vert-rhythm typography">
                                    
                                    <?php $page->the_content(); ?>
<!--
<h1>Heading one. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</h1>
...
<h2>Heading two. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</h2>
...
<h3>Heading three. Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</h3>
<p>Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</p>
<dl>
...
<h4>Heading four. Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</h4>
<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. </p>
<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. </p>
<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. </p>

<h5>Heading five. Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</h5>
<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. </p>

<h6>Heading six. Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</h6>
<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. </p>
-->
...
/* For the style guide */
    ...
    <p><strong>These are basic markup and typographic styles for your site and how to use them.</strong> Most of these options are availabel through the TinyMCE edit window in the admin, but some will require knowledge of coding HTML.</p><!-- Menu -->
...
<code>&lt;h1&gt;This is a heading of primary importance&lt;/h1&gt;</code>
</pre>
    ...
    <p>The header above is an <code>&lt;h6&gt;</code> element, which may be used for any form of page-level header which falls below the <code>h5</code> header in a document hierarchy.</p><!-- end Headings -->
    <!-- Groupings -->
...
<code>&lt;p&gt;This is a paragraph&lt;/p&gt;</code>
    ...
    <div class="example">
        <blockquote cite="//hansard.millbanksystems.com/commons/1947/nov/11/parliament-bill#column_206">
        ...
        <p>&mdash; <cite><a href="//hansard.millbanksystems.com/commons/1947/nov/11/parliament-bill#column_206" target="_blank">Parliament Bill 1947, Column 206</a></cite></p>
    </div>
    <pre class="examplecode">
<code>&lt;blockquote cite="http://link-to-source.com"&gt;
    &lt;p&gt;Quoted text&lt;/p&gt;
&lt;/blockquote&gt;
&lt;p&gt;— &lt;cite&gt;&lt;a href="http://link-to-source.com"&gt;Source of the Quote&lt;/a&gt;&lt;/cite&gt;&lt;/p&gt;</code>
</pre>
    <hr>
...
&lt;/dl&gt;</code>
    ...
    <div class="example">
        <figure>
            <p>&lsquo;Twas brillig, and the slithy toves<br>
...
&lt;/figure&gt;</code>
    ...
    <p><a href="#menu">Back to Top &uarr;</a></p><!-- Text semantics -->
    ...
    <pre class="examplecode">
<code>&lt;a href="link/to/page"&gt;link text&lt;/a&gt;</code>
</pre>
    ...
    <pre class="examplecode">
<code>You simply &lt;em&gt;must&lt;/em&gt; try the negitoro maki!</code>
</pre>
    ...
    <pre class="examplecode">
<code>&lt;strong&gt;Do not under any circumstances&lt;/strong&gt; stick nails in the electrical outlet.</code>
</pre>
    ...
    <pre class="examplecode">
<code>Order now, only $5.99! &lt;small&gt;Some restrictions may apply.&lt;/small&gt;</code>
</pre>
    ...
    <pre class="examplecode">
<code>&lt;s&gt;Recommended retail price: $3.99 per bottle&lt;/s&gt; Now selling for just $2.99 a bottle!</code>
</pre>
    ...
    <pre class="examplecode">
<code>f(&lt;var&gt;x&lt;/var&gt;, &lt;var&gt;n&lt;/var&gt;) = log&lt;sub&gt;4&lt;/sub&gt;&lt;var&gt;x&lt;/var&gt;&lt;sup&gt;&lt;var&gt;n&lt;/var&gt;&lt;/sup&gt;</code>
</pre>
    ...
    <pre class="examplecode">
<code>&lt;cite&gt;Universal Declaration of Human Rights&lt;/cite&gt;, United Nations, December 1948. Adopted by General Assembly resolution 217 A (III).</code>
</pre>
    ...
    <pre class="examplecode">
<code>John said, &lt;q&gt;I saw Lucy at lunch, she told me &lt;q&gt;Mary wants you to get some ice cream on your way home&lt;/q&gt;. I think I will get some at Ben and Jerry&rsquo;s, on Gloucester Road.&lt;/q&gt;</code>
</pre>
    ...
    <pre class="examplecode">
<code>Bob&rsquo;s &lt;dfn title="Dog"&gt;canine&lt;/dfn&gt; mother and &lt;dfn title="Horse"&gt;equine&lt;/dfn&gt; father.</code>
</pre>
    ...
    <pre class="examplecode">
<code>&lt;abbr title="HyperText Markup Language"&gt;HTML&lt;/abbr&gt;is a common abbreviated term</code>
</pre>
    ...
    <pre class="examplecode">
<code>When you call the &lt;code&gt;activate()&lt;/code&gt; method</code>
</pre>
    ...
    <pre class="examplecode">
<code>If there are &lt;var&gt;n&lt;/var&gt; pipes&hellip;</code>
</pre>
    ...
    <pre class="examplecode">
<code>The computer said &lt;samp&gt;Too much cheese&lt;/samp&gt;&hellip;</code>
</pre>
    ...
    <pre class="examplecode">
<code>Press the &lt;kbd&gt;⌘ Cmd&lt;/kbd&gt; key&hellip;</code>
</pre>
    ...
    <pre class="examplecode">
<code>Maybe I should adopt a &lt;mark&gt;kitten&lt;/mark&gt;</code>
</pre>
    ...
    <pre class="examplecode">
<code>She bought &lt;del datetime="2005-05-30T13:00:00"&gt;two&lt;/del&gt; &lt;ins datetime="2005-05-30T13:00:00"&gt;five&lt;/ins&gt; pairs of shoes.</code>
</pre>

    <p><a href="#menu">Back to Top &uarr;</a></p><!-- Tables -->
...
<p><a href="#menu">Back to Top &uarr;</a></p><!-- Forms -->
...
<div class="example">
    <form>
        <fieldset title="Sample input field types">
            <legend>Input Field Types</legend>

            <p><label for="text">Text Input</label> <input id="text" class="input" type="text" required="required"> <small class="element-caption">This is a sample input field of type="text"</small></p>

            <p><label for="password">Password</label> <input id="password" class="input" type="password" required="required"> <small class="element-caption">This is a sample input field of type="password"</small></p>

            <p><label for="email">Email Address</label> <input id="email" class="input" type="email" placeholder="you @ example . com" required="required"> <small class="element-caption">This is a sample input field of type="email"</small></p>

            <p><label for="url">Web Address</label> <input id="url" class="input" type="url" placeholder="http://example.com" required=""> <small class="element-caption">This is a sample input field of type="url"</small></p>

            <p><label for="url">Phone Number</label> <input id="phone" class="phone" type="tel" placeholder="000-000-0000" required=""> <small class="element-caption">This is a sample input field of type="number"</small></p>

            <p><label for="textarea">Textarea</label> 
            <textarea id="textarea" class="input" rows="8" cols="32" required="">
</textarea> <small class="element-caption">This is a sample textarea for multi-line user input</small></p>
        </fieldset>
        ...
        <fieldset title="Selectable Option Items">
            ...
            <small class="element-caption">A select form element contains more than one <code>&lt;option&gt;</code> element</small></p>

            <ul class="menu horizontal-list">
                <li><label for="checkbox1" class="check"><input id="checkbox1" name="checkbox" type="checkbox" checked="checked"> Choice A</label></li>

                <li><label for="checkbox2" class="check"><input id="checkbox2" name="checkbox" type="checkbox"> Choice B</label></li>

                <li><label for="checkbox3" class="check"><input id="checkbox3" name="checkbox" type="checkbox"> Choice C</label></li>
            </ul>

            <p><small class="element-caption">Checkboxes can be selected independently, and more than one can be selected</small></p>

            <ul class="menu horizontal-list">
                <li><label for="radio1" class="check"><input id="radio1" name="radio" type="radio" class="radio" checked="checked"> Option 1</label></li>

                <li><label for="radio2" class="check"><input id="radio2" name="radio" type="radio" class="radio"> Option 2</label></li>

                <li><label for="radio3" class="check"><input id="radio3" name="radio" type="radio" class="radio"> Option 3</label></li>
            </ul>
        ...
        <fieldset title="Buttons">
            ...
            <p><code>input type="submit"</code>, <code>&lt;button&gt;</code>, <code>input type="reset"</code> and an <code>&lt;a class="button"&gt;</code></p>
            <p>
                <input class="primary-action" type="submit" value="Post comment"> 
                <button class="primary-action">Preview</button> 
                <input class="secondary-action" type="reset" value="Clear Form"> 
                <a class="button secondary-action" href="#">Cancel</a>
            </p>
        </fieldset>
    </form>
</div>
